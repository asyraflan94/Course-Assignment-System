...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
    <ul>
      ...
      <li class="{{ Request::is('admin/suggested-general-subject') ? 'active' : '' }}"><a href="{{url('/admin/generated-subject')}}"><i class="icon icon-list-ol"></i> <span>Subject Generated</span></a></li>
      <li class="{{ Request::is('admin/generate-subject') ? 'active' : '' }}"><a href="{{url('/admin/generate-subject')}}"><i class="icon icon-list-ol"></i> <span>Generate Subject</span></a></li>
